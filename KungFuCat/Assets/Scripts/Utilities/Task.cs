...
public class LerpCameraPos : TimedGOTask
{
    public float Start { get; private set; }
    public float End { get; private set; }
    public bool Moving;

    public LerpCameraPos(GameObject gameObject, float start, float end, float duration, bool _moving) : base(gameObject, duration)
    {
        Start = start;
        End = end;
        Moving = _moving;
    ...
    protected override void OnTick(float t)
    {
        Services.Camera.yPos = Mathf.Lerp(Start, End, t);
        Services.Camera.moving = Moving;
    }
}
...
public class Speak : GOTask
{
    private readonly Transform _pos;
    private string _text;
    private float _duration;
    private SpeechBubbleManager.SpeechbubbleType _speechType;

    public Speak(GameObject gameObject, Transform pos, string text, float duration, SpeechBubbleManager.SpeechbubbleType speechType) : base(gameObject)
    {
        _pos = pos;
        _text = text;
        _duration = duration;
    ...
    protected override void Init()
    {
        Services.SpeechBubble.AddSpeechBubble(_pos, _text, _speechType, _duration);
        SetStatus(TaskStatus.Success);
    }
}
